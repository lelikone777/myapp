    ...
    <Section>
      <div className="mx-auto flex max-w-3xl flex-col gap-6">
        <div className="space-y-3">
          ...
          <h1 className="text-3xl font-semibold sm:text-4xl">Let&apos;s work together</h1>
          <p className="text-lg text-[var(--muted)]">
            I&apos;m open to React/Next.js roles and freelance projects. Remote-first, comfortable collaborating across
            time zones.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
              ...
              >
                ...
                <span className="text-sm text-[var(--muted)] group-hover:text-[var(--foreground)]">GitHub</span>
              </a>
              <a
              ...
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--card)] transition group-hover:border-[var(--accent)] group-hover:bg-[var(--nav-hover)]">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
                    <path d="M20.452 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.447-2.136 2.941v5.665H9.354V9h3.414v1.561h.05c.476-.9 1.637-1.85 3.369-1.85 3.601 0 4.268 2.371 4.268 5.456zM5.337 7.433a2.062 2.062 0 1 1 0-4.124 2.062 2.062 0 0 1 0 4.124zM7.114 20.452H3.56V9h3.554z" />
                  </svg>
                </span>
                <span className="text-sm text-[var(--muted)] group-hover:text-[var(--foreground)]">LinkedIn</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-sm text-[var(--muted)] group-hover:text-[var(--foreground)]">Telegram</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-sm text-[var(--muted)] group-hover:text-[var(--foreground)]">WhatsApp</span>
              </a>
            </div>
          </div>
        </Card>
        ...
        <p className="text-sm text-[var(--muted)]">Typically respond within 1 business day.</p>
      </div>
    </Section>
  );
};
